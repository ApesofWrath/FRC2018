...
public:
	...
	void GenerateScale(bool left_scale, bool switch_, bool left_switch, bool scale_added, bool left_scale_added);
	...
	void RunStateMachineTwoScale(bool *place_scale_backwards, bool *get_cube_ground);
